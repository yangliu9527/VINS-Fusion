...
void solveGyroscopeBias(map<double, ImageFrame> &all_image_frame, Vector3d* Bgs)
{
    Matrix3d A;
    Vector3d b;
    Vector3d delta_bg;//求解的是陀螺零偏的更新量
    A.setZero();
    b.setZero();
    ...
    // min||Qij.inverse*deltaQij*1/2*Jbg*deltabg||=>Qij.inverse*deltaQij*1/2*Jbg*deltabg=I=>Jbg.transpose*Jbg*deltabg = 2Jbg.transpose*deltaQij.inverse*Qij
...
bool LinearAlignment(map<double, ImageFrame> &all_image_frame, Vector3d &g, VectorXd &x)
{
    ...
    MatrixXd A{n_state, n_state};//A用来存方程系数矩阵
    A.setZero();
    VectorXd b{n_state};
    b.setZero();
...
/// @brief 视觉惯性对齐，优化bias、尺度因子、速度、重力方向
/// @param all_image_frame 
/// @param Bgs 
/// @param g 
/// @param x 
